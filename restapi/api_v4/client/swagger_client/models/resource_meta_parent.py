...
class ResourceMetaParent(object):
    ...
    def __init__(self, url=None):  # noqa: E501
        """ResourceMetaParent - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this ResourceMetaParent.  # noqa: E501


        :return: The url of this ResourceMetaParent.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceMetaParent):
            return False
