...
type DataReference struct {
	...
	// The data source type like COS or dashDB. Allowed values for type are 's3' for COS and 'dashdb' for dashDB
	...
	// https://api.dataplatform.cloud.ibm.com/schemas/common-pipeline/datarecord-metadata/datarecord-metadata-v2-schema.json
