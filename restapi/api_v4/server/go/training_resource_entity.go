...
type TrainingResourceEntity struct {
	...
	Experiment *ExperimentObject `json:"experiment,omitempty"`

	Pipeline *PipelineObject `json:"pipeline,omitempty"`

	TrainingDataReferences []DataReference `json:"training_data_references"`

	ResultsReference *ObjectLocation `json:"results_reference"`

	Status *Status `json:"status,omitempty"`

	SubTrainings []TrainingResource `json:"sub_trainings,omitempty"`
}
